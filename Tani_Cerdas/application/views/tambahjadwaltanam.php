      ...
      <div class="widget-content">
        <div class="control-group">
            ...
            <div class="control-group">
             ...
             <div class="control-group">
              <label class="control-label">ID Tanaman</label>
              <div class="controls">
                <input type="text"  class="span11" placeholder="ID Tanam" name="id_tanaman" value="<?php echo set_value('id_tanaman', '') ?>" required />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text"  class="span11" placeholder="ID Tanam" name="id_lahan" value="<?= $id_lahan ?>" required />
              </div>
            </div>
