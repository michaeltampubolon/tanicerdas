                  ...
                  <td> 
                      <div class="widget-box collapsible">    
                        <?php $no=0; foreach($tampil as $row ): $no++;?>
                          <div class="widget-title"> <a href="#<?php echo $row->nama_komunitas;?>" data-toggle="collapse"> <span class="icon"><i class="icon-remove"></i></span>
                            <h5>Komunitas <?php echo $row->nama_komunitas;?></h5>
                            </a> 
                          </div>
                        <?php endforeach; ?>
                      </div>
