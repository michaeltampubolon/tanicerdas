...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Timeline</a>
  <ul>
    <li class="active"><a href="<?php echo base_url();?>index.php/Beranda"><i class="icon icon-home"></i> <span>Timeline</span></a> </li>
    <li> <a href="<?php echo base_url();?>index.php/Beranda/lahan"><i class="icon icon-inbox"></i> <span>Manajemen Lahan</span></a> </li>
    <li> <a href="widgets.html"><i class="icon icon-inbox"></i> <span>Manajemen Lahan</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?php echo base_url();?>index.php/Beranda" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Timeline</a></div>
  </div>
<!--End-breadcrumbs-->
            ...
            <div class="chat-users panel-right2">
              ...
              <div class="panel-content nopadding">
                <ul class="contact-list">
                  <li id="user-Alex" class="online"><a href=""><img alt="" src="<?php echo base_url();?>assets/img/demo/av1.jpg" /> <span>Alex</span></a></li>
                  <li id="user-Linda"><a href=""><img alt="" src="<?php echo base_url();?>assets/img/demo/av2.jpg" /> <span>Linda</span></a></li>
                  <li id="user-John" class="online new"><a href=""><img alt="" src="<?php echo base_url();?>assets/img/demo/av3.jpg" /> <span>John</span></a><span class="msg-count badge badge-info">3</span></li>
                  <li id="user-Mark" class="online"><a href=""><img alt="" src="<?php echo base_url();?>assets/img/demo/av4.jpg" /> <span>Mark</span></a></li>
                  <li id="user-Maxi" class="online"><a href=""><img alt="" src="<?php echo base_url();?>assets/img/demo/av5.jpg" /> <span>Maxi</span></a></li>
                </ul>
              </div>
            </div>
