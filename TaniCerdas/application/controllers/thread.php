...
class Thread extends CI_Controller {
    ...
    public function talk($slug, $start = 0){
        ...
        $this->load->model('penyuluh_model');
        $this->data['cat']    = $this->penyuluh_model->category_get_all_parent($thread->category_id, 0);
    ...
    public function category($slug, $start = 0)
    {
        ...
        $this->load->model('penyuluh_model');
        $this->data['cat']    = $this->penyuluh_model->category_get_all_parent($category->id, 0);
        $this->data['thread'] = $category;
        
        $cat_id = array();
        $child_cat = $this->penyuluh_model->category_get_all($category->id);
